            ...
            <section className="bg-white dark:bg-[#151517] rounded-2xl p-4 border border-zinc-200 dark:border-zinc-800 shadow-sm transition-colors duration-300">
                <div className="flex flex-col gap-3 mb-4">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                        <div>
                            ...
                            <p className="text-[11px] text-zinc-500 dark:text-zinc-400">Linha do tempo desde o início do sistema.</p>
                        </div>
                ...
                {trendCategoryNames.length > 0 && categoryTrendPoints.length > 0 ? (
                    <>
                        ...
                        {(categoryTrendSummary.highlights.categoryMaisPesada ||
                          ...
                          categoryTrendSummary.highlights.maiorQueda) && (
                            <div className="mt-4 grid gap-3 text-[10px] text-zinc-500 dark:text-zinc-400">
                                {categoryTrendSummary.highlights.categoryMaisPesada && (
                        ...
                        {categoryTrendSummary.insights.length > 0 && (
                            <div className="mt-3 bg-zinc-50 dark:bg-[#111113] border border-zinc-200 dark:border-zinc-800 rounded-2xl p-3">
                                <p className="text-[10px] font-bold uppercase text-zinc-500 dark:text-zinc-400 mb-2">Insights automáticos</p>
                    ...
                    <div className="flex flex-col items-center justify-center py-10 text-zinc-400">
                        ...
                        <p className="text-xs text-center">Dados insuficientes para montar a tendência das categorias.</p>
                    </div>
                )}
            </section>
        )}
