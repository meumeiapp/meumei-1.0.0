...
const GlobalHeader: React.FC<GlobalHeaderProps> = ({ 
  ...
  return (
    <div className="pwa-safe-top w-full bg-gradient-to-r from-blue-600/80 via-indigo-600/80 to-pink-600/80 rounded-b-[24px] md:rounded-b-[32px] sticky top-0 z-[999] shadow-2xl shadow-indigo-500/20 mb-4 md:mb-8 transition-all duration-300 backdrop-blur-xl">
         {/* Background Pattern */}
         <div className="absolute top-0 left-0 w-full h-full opacity-15 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] rounded-b-[24px] md:rounded-b-[32px]"></div>
         
         <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-2 pb-5 md:pt-4 md:pb-10 relative z-10">
             {isMobile ? (
                 <MobileHeader
                     ...
                     <div className="flex items-center justify-between gap-3 md:gap-6">
                        <div className="flex flex-col items-start justify-center gap-1 min-w-0 max-w-[45%] md:max-w-none">
                            <button 
                                ...
                                className="flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur-md px-2.5 py-1 md:px-3 md:py-1.5 rounded-full border border-white/5 transition-all group max-w-full"
                                ...
                                <div className="flex flex-wrap items-center justify-end gap-2">
                                    <div className="flex items-center gap-1 rounded-full bg-white/10 backdrop-blur-md border border-white/5 p-1">
                                        <button
                                            ...
                                            className={`p-1 md:p-1.5 rounded-full transition-all ${
