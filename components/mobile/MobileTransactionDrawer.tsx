          ...
          <div className="mt-5 grid grid-cols-2 gap-3">
            ...
            {onDelete && (
              <button
                type="button"
                onClick={onDelete}
                className={`rounded-xl border border-red-200 dark:border-red-900/40 py-2.5 text-sm font-semibold text-red-600 dark:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 ${
                  actionsDisabled ? 'opacity-50 cursor-not-allowed' : ''
                }`}
                disabled={actionsDisabled}
              >
