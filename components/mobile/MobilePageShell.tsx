...
const MobilePageShell: React.FC<MobilePageShellProps> = ({
  ...
  return (
    <div
      className={`min-h-screen mm-mobile-shell bg-gray-50 dark:bg-[#09090b] text-zinc-900 dark:text-white font-inter pb-[calc(env(safe-area-inset-bottom)+72px)] transition-colors duration-300 overflow-x-hidden ${
        className || ''
      }`}
    >
      <div
